...
// Function to display success notification from frontend
function successNotification(header, message) {
    toastr.options = {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
...
function errorNotification(header, message) {
    toastr.options = {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
...
function infoNotification(header, message) {
    toastr.options = {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
...
function warningNotification(header, message) {
    toastr.options = {
        "closeButton": true,
        "debug": false,
        "newestOnTop": false,
